...
type Record struct {
	...
	Value  []byte `protobuf:"bytes,1,opt,name=value,proto3" json:"value,omitempty"`    //오른쪽은 ID
	Offset uint64 `protobuf:"varint,2,opt,name=offset,proto3" json:"offset,omitempty"` //repeated Record records = records []Record랑 같다
}
...
var file_api_v1_log_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x42, 0x1f, 0x5a, 0x1d, 0x67, 0x69, 0x74, 0x68, 0x69, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	0x2f, 0x73, 0x6c, 0x65, 0x65, 0x67, 0x30, 0x30, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x6c, 0x6f, 0x67,
